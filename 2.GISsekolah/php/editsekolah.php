...
// ambil data di URL
$id = $_GET["id"];
// query data  berdasarkan ID nya
$sekolah = query("SELECT * FROM tbl_sekolah WHERE id_sekolah =$id")[0];
...
if(ubah($_POST)> 0){
    ...
    <script>
        ...
        document.location.href = 'editsekolah.php';
    </script>
";
}
}
            ...
            <div class="col-md-5 col-sm-7">
                <div class="panel panel-primary">
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data" name="myform">
                        <input type="hidden" name="id_sekolah" id="id" value="<?=$sekolah["id_sekolah"];?>">
                        <div class="form-group">
                            <label>Nama Sekolah</label>
                            <input name="nama_sekolah" placeholder="Isikan Nama Sekolah" class="form-control" value="<?= $sekolah["nama_sekolah"];?>" />
                        </div>
                        <div class="form-group">
                            <label>Alamat Sekolah</label>
                            <input name="alamat" placeholder="Isikan Alamat Sekolah" class="form-control"  value="<?= $sekolah["alamat"];?>" />
                        </div>
                        <div class="form-group">
                            <label>Status</label>
                        ...
                        <div class="form-group">
                            ...
                            <input name="kepala_sekolah" placeholder="Isikan Nama Kepala Sekolah" class="form-control" value="<?= $sekolah["alamat"];?>" />
                        </div>
                        <div class="form-group">
                            <label>Latitude</label>
                            <input id="Latitude" name="latitude" class="form-control" value="<?= $sekolah["latitude"];?>" />
                        </div>
                        <div class="form-group">
                            <label>Longitude</label>
                            <input id="Longitude" name="longitude" class="form-control" value="<?= $sekolah["longitude"];?>" />
                        </div>
                        <div class="form-group">
                            <label>Keterangan</label>
                            <input name="keterangan" placeholder="Isikan Keterangan  Sekolah" class="form-control" value="<?= $sekolah["keterangan"];?>"/>
                        </div>
                        <div class="form-group">
                            <label></label>
