<?php 
$global_lokasi = json_decode(file_get_contents('https://api.kawalcorona.com/'),true);
...
<div id="wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Pemetaan GLobal Covid-19 berdasarkan Negara</h1>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <script>
                    ...
                    <?php foreach($global_lokasi as $key) :?>
                        L.marker([<?= $key["attributes"]["Lat"];?>,<?= $key["attributes"]["Long_"];?>]).addTo(mymap)
                        .bindPopup("Negara: <?= $key["attributes"]["Country_Region"];?><br>"+
                                    "Positif : <?= $key["attributes"]["Confirmed"];?><br>" +
                                    "Sembuh : <?= $key["attributes"]["Recovered"];?><br>" +
                                    "Meninggal : <?= $key["attributes"]["Deaths"];?><br>" 
                        ).openPopup();
