<?php 
$global_positif = json_decode(file_get_contents('https://api.kawalcorona.com/positif/'),true);
$global_sembuh = json_decode(file_get_contents('https://api.kawalcorona.com/sembuh/'),true);
$global_meninggal = json_decode(file_get_contents('https://api.kawalcorona.com/meninggal/'),true);
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
            ...
            <div class="panel-heading">
                ...
                <div class="col-xs-9 text-right">
                    <div class="huge"><?=$global_positif['value'];?></div>
        ...
        <div class="col-lg-4 col-md-6">
            ...
            <div class="panel-heading">
                ...
                <div class="col-xs-9 text-right">
                    <div class="huge"><?=$global_sembuh['value'];?></div>
        ...
        <div class="col-lg-4 col-md-6">
            ...
            <div class="panel-heading">
                ...
                <div class="col-xs-9 text-right">
                    <div class="huge"><?=$global_meninggal["value"];?></div>
            ...
            <div class="panel panel-primary">
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $no++;?></td>
                                <td> <span ><?= $key["attributes"]["Country_Region"];?></span></td>
                                <td> <span class="badge badge-red "><?= $key["attributes"]["Confirmed"];?></span></td>
                                <td> <span class="badge badge-success"><?= $key["attributes"]["Recovered"];?></span></td>
                                <td> <span class="badge badge-danger"><?= $key["attributes"]["Deaths"];?></span></td>
